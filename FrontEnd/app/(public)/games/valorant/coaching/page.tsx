...
export const metadata: Metadata = {
  title: 'Valorant Coaching | Learn from Radiant Players',
  description: 'Book personalized Valorant coaching sessions with Radiant-level players to master agents, maps, and strategies.',
};
