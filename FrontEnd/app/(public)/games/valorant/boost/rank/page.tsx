...
export const metadata: Metadata = {
  title: 'Valorant Rank Boost | Professional Valorant Boosting',
  description: 'Reach your desired rank in Valorant with our secure and efficient boosting service. Radiant-level players at your service.',
};
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-2">
            <h1 className="text-3xl font-bold mb-6">Configure Your Rank Boost</h1>
            <OrderForm>
              <RankSelector />
              <DuoToggle />
            </OrderForm>
...
export default ValorantRankBoostPage;
