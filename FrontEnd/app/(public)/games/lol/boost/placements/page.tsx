...
export const metadata: Metadata = {
  title: 'League of Legends Placement Matches | Professional Boosting',
  description: 'Start your season strong with our professional LoL placement matches boosting service. High win-rate performance.',
};
...
export default LolPlacementsPage;
